...
public class OfferDelete extends AbstractServlet {
    ...
    public void init() throws ServletException {
        try {
            ...
            path = String.format("%s/webapps/ch2_carStoreWeb/fotos", path);
     ...
     * http://bot.net:8080/ch2_carStoreWeb/offer-delete/
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            req.setAttribute("id", strId);
            Offer offer = this.getOffer(strId);
            if (offer != null && offer.getUser().getName().equals(req.getParameter("name"))) {
                ...
                } else if (!offer.getUser().getName().equals(req.getParameter("name"))) {
