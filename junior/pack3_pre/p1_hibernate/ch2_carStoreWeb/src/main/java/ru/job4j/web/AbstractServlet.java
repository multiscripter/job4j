...
public abstract class AbstractServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
    	try {
            ...
            // /var/lib/tomcat8/webapps/ch2_carStoreWeb/WEB-INF/classes
            // \Program FIles\Apache Software Foundation\Tomcat 8.5\webapps\ch2_carStoreWeb\WEB-INF\classes
            ...
            Configuration conf = xcf.getConfiguration(new LoggerContext("ch2_carStoreWeb_context"), source);
