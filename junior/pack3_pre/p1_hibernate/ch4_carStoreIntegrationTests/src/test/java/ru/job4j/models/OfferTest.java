...
public class OfferTest {
    ...
    public void beforeTest() {
        this.items.put("body", new Body(1, "sedan"));
        ...
        this.offer = new Offer(0, this.items, 100500, false);
    }
    /**
    ...
    private Offer getExpected() {
        ...
        offer.setBody(new Body(1, "sedan"));
        List<Body> bodies = new ArrayList<>();
        bodies.add(new Body(1, "sedan"));
        bodies.add(new Body(2, "hatchback"));
        Founder founder = new Founder(0, "ЦК КПСС", "Совет министров СССР");
