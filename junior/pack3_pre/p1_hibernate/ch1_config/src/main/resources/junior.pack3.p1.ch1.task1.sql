...
/*
insert into users (name, login, email, created, pass) values ('Путин', 'president', 'putin@kremlin.gov', '1952-10-07', 'ab788932cee4ff449d2ec584da8af2b7'); pass: putin
insert into users (name, login, email, created, pass) values ('Навальный', 'savior', 'naval@fbk.ru', '1976-06-04', '58634504e4d833e42588ecbc266085aa'); pass: navalniy
insert into users (name, login, email, created, pass) values ('Жирик', 'zhirik', 'zhirik@ldpr.ru', '1976-06-04', 'a4a4ff13a635bd92d6c69ada92ac2a90'); pass: zhirik
update users set login = 'newlogin',email = 'new@email.ru',name = 'Новое имя',created = '2000-01-01' where id = 4;
*/