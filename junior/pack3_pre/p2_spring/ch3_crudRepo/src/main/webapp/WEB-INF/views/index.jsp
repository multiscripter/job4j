    ...
    <div class="container">
        <div class="row">
            <div class="col col-xs-12 col-sm-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
                <h1 class="text-center">CrudRepository. Площадка продаж машин.</h1>
                <h4 class="text-center">junior.pack3.p4.ch3.task1</h4>
                        ...
                        <ul class="offer-details">
                            <li class="offer-pic">
                                ...
                                <c:forEach items="${item.fotos}" var="foto">
                                    <li class="foto-item">
                                        <a class="foto-ref" data-fancybox="gallery-${item.id}" href="${refRoot}fotos/${item.id}/${foto}">
                                            <img class="foto-pic" src="${refRoot}fotos/${item.id}/${foto}" alt="" />
                                        </a>
                                    </li>
                                </c:forEach>
                                </ul>
