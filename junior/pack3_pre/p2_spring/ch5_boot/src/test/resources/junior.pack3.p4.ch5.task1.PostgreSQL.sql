...
insert into users (name, password, enabled) values ('testUser1', '$2y$08$a0DqbFLfZFPxWUvya0Dqb./jiQcqHkOIySIF074y7VFj5JFvLgRwW', true);
insert into users (name, password, enabled) values ('testUser2', '$2y$08$a0DqbFLfZFPxWUvya0Dqb.5Y1leQvjCroddm6QGEJF7pe/PBs1sWO', true);
