                        ...
                        <li class="offer-pic">
                            <ul class="foto-list">
                                <c:forEach items="${offer.fotos}" var="foto">
                                    <li class="foto-item">
                                        <a class="foto-ref" data-fancybox="gallery-${offer.id}" href="${refRoot}resources/fotos/${offer.id}/${foto}">
                                            <img class="foto-pic" src="${refRoot}resources/fotos/${offer.id}/${foto}" alt="" />
                                        </a>
                                    </li>
                                </c:forEach>
                            </ul>
