...
public class OfferTest {
    ...
    public void beforeTest() {
        ...
        User user = new User(true, 1L, "testUser1", "passhash");
    ...
    public void testToString() {
        ...
        assertEquals("Offer[id: 0, user: User[id: 1, name: testUser1, activity: true], car: Car[id: 0, name: Vesta, bodies:[Body[id: 1, name: sedan]Body[id: 2, name: hatchback]], brand: Brand[id: 0, name: ВАЗ, founder: Founder[id: 0, nameLast: ЦК КПСС, name: Совет министров СССР]]], body: Body[id: 1, name: sedan], price: 100500, status: false]", o.toString());
    }
}
