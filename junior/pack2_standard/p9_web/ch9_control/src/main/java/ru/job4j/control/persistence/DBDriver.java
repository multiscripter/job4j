...
public class DBDriver {
    ...
    public static final class SingletonHolder {
         ...
         * Синглетон.
         */
        static final DBDriver INSTANCE = new DBDriver();
    }
    /**
     * Соединение с бд.
     */
    ...
    /**
     * Проверяет закрыт ли объект драйвера.
     ...
     */
    public boolean isDBDriverSet() {
        return this.ds != null;
    }
    /**
     * Получает число активных соединений.
     * @return число активных соединений.
     */
