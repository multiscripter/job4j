...
public class Read extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			sb.append("</h1>\n");
			//sb.append(Charset.defaultCharset().toString() + " Charset.defaultCharset().toString()<br />\n");
			//sb.append(Charset.defaultCharset().name() + " Charset.defaultCharset().name()<br />\n");
			//sb.append(System.getProperty("file.encoding") + " System.getProperty('file.encoding')<br />\n");
			if (users.size() > 0) {
				sb.append("    <table>\n");
				sb.append("        <tr>\n");
				sb.append("            <th>");
